    ...
    public class TaiKhoanDA
    {
        public List<TaiKhoan> GetAll()
        {
            ...
            while (reader.Read())
            {
                ...
                tk.MaCV= int.Parse(reader["MaCV"].ToString());
        ...
        public int Insert_Update_Delete(TaiKhoan tk, int action)
        {
            ...
            SqlParameter namePara = new SqlParameter("@TenTaiKhoan", SqlDbType.Int);
            ...
            cmd.Parameters.Add("@MaCV", SqlDbType.Int).Value = tk.MaCV;
